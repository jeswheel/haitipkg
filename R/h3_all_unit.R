#' Fit Model 3 SpatPomp, all unit specific
#'
...
h3_all_unit <- function(
  ...
  # For this function, it's really unit_specific names as well.
  ...
  t_global <- system.time(
    foreach(
      ...
      ibpf_out <- ibpf(
        ...
        Np = search1$NP,
        sharedParNames = NULL,
        unitParNames = c(unit_specific_names, shared_param_names),
