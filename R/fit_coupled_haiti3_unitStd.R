...
#'
#' @export
fit_coupled_haiti3_unitStd <- function(
    search1 = list(
      NBPF = 5,
      NP = 50,
      SPAT_REGRESSION = 0.5,
  ...
  unit_specific_names <- c("betaB", "foi_add", "std_W", "aHur", "hHur")

  shared_param_names <- c(
    "mu_B", "XthetaA", "thetaI", "lambdaR", "r",
    "epsilon", "k", "sigma"
  )
  ...
  shared_ub <- c(500, 0.8, 0.0001, 5, 1.75, 1, 250, 0.3)
